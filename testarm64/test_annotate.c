...
static const char *func_strenc_prob50(void) {
...
static const char *func_strenc_subxor100(void) {
...
static const char *func_strenc_no_cleanup(void) {
...
static int func_flatten(int x, int y) {
    int result = 0;
    if (x > 100) {
        if (y > 50) result = x + y;
        else result = x - y;
...
static int func_eibr_no_stack(int choice, int a, int b) {
...
static const char *func_no_strenc(void) {
...
static int func_eibr_with_stack(int choice, int a, int b) {
    op_func ops[] = {op_add, op_sub, op_mul};
    if (choice < 0 || choice > 2) choice = 0;
    int r1 = ops[choice](a, b);
...
static void test_strenc_prob50(void) {
...
static void test_strenc_subxor100(void) {
...
static void test_strenc_no_cleanup(void) {
...
static void test_eibr_no_stack(void) {
...
static void test_no_strenc(void) {
...
static void test_eibr_with_stack(void) {
